...
export default function Privacy() {
  return (
    <>
      <Head>
        <title>Svindland | Privacy Policy</title>
      ...
      <main className={styles.main}>
        ...
        <p>
          ...
          SERVICE is provided by Samuel Svindland at no cost and is intended for
          use as is.
        </p>
        <p>
        ...
        <p>
          ...
          not hesitate to contact me at swsvindland@gmail.com.
        </p>
        <p>
