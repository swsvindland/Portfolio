    ...
    return (
        <PageLayout>
            <div style={{ padding: 24 }}>
                ...
                <p>
                    Samuel Svindland built his apps, WaterTrack; BodyTrack;
                    PeriodTrack; etc, as an Ad Supported app. This SERVICE is
                    provided by Samuel Svindland at no cost and is intended for
                    use as is.
                </p>
                <p>
                ...
                <p>
                    ...
                    WaterTrack unless otherwise defined in this Privacy Policy.
                </p>
                <p>
                ...
                <p>
                    ...
                    email. Any calculations regarding your period cycle,
                    fertility, and ovulation are performed on your device to
                    maintain privacy and is not collected by Samuel Svindland or
                    by any third party service providers.
                </p>
                <p>
                    In order to enable cloud sync, default cycle, time zone,
                    flow rate, intimacy, and notes are uploaded to the cloud.
                    This data is not sold or used to track individual users.
                </p>
                <p>
                    No information entered into PeriodTrack is ever sold to
                    third parties or used to track individual users. All
                    information that is stored on the cloud is used to create
                    the best user experience and ensure app efficiency,
                    convenience, and accuracy.
                </p>
                <p>
                    Upon using the “Delete Account” feature, all user data is
                    automatically removed from all storage points.
                </p>
                <div>
                    <p>
