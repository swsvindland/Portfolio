    ...
    return (
        <PageLayout>
            <div style={{padding: 24}}>
                ...
                <p>
                    The WaterTrack app stores and processes personal data that
                    you have provided to us, in order to provide my Service.
                    It’s your responsibility to keep your phone and access to
                    the app secure. We therefore recommend that you do not
                    ...
                    that the WaterTrack app won’t work properly or at all.
                </p>
                <div>
                    <p>
                ...
                <p>
                    ...
                    Samuel Svindland will not take responsibility for. Certain
                    functions of the app will require the app to have an active
                    internet connection. The connection can be Wi-Fi, or
                    provided by your mobile network provider, but Samuel
                    Svindland cannot take responsibility for the app not working
                ...
                <p>
                    ...
                    Samuel Svindland cannot accept responsibility.
                </p>
                <p>
                    With respect to Samuel Svindland’s responsibility for your
                    ...
                    available to you. Samuel Svindland accepts no liability for
                ...
                <p>
                    ...
                    using the app. Samuel Svindland does not promise that it
